...
CMD ["java", "--add-exports=io.grpc/io.opencensus.common=gax", "--add-exports=io.grpc/io.opencensus.trace=gax", "--add-exports=io.grpc/io.opencensus.tags=google.cloud.bigtable", "--add-exports=io.grpc/io.opencensus.stats=google.cloud.bigtable", "--add-exports=io.grpc/io.opencensus.trace=com.google.api.client", "--add-exports=io.grpc/io.opencensus.trace.propagation=com.google.api.client", "--add-exports=io.grpc/io.opencensus.trace.propagation=opencensus.contrib.http.util", "-p", "/app/lib", "-m", "no.ssb.dapla.catalog/no.ssb.dapla.catalog.Application"]
